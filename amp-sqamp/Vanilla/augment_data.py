...
parser.add_argument('--is_normal', type=bool, default=False, help='Normalize data')
...
parser.add_argument('--n_samples', type=int, default=4, help='Number of aug samples')
parser.add_argument('--seed', type=int, default=None, help='Random seed for reproducibility')  # Added seed argument
